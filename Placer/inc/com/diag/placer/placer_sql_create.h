 ...
 * This macro generates the front matter for an SQL CREATE TABLE for the schema.
 ...
 * This macro generates the end matter for an SQL CREATE TABLE for the schema.
