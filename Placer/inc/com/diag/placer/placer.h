...
/**
 * Emit the SQLite error message to the log if it is non-NULL and then free it.
 ...
 */
extern void placer_message_f(const char * file, int line, char * message);

/**
 * @def placer_message
 * Calls placer_message_f with __FILE__, __LINE__, and @a _MESSAGE_.
 */
#define placer_message(_MESSAGE_) placer_message_f(__FILE__, __LINE__, _MESSAGE_)

/**
 * Turn the SQLite error number into a printable string and log it.
 * @param file is the nul-terminated string generated by __FILE__.
 * @param line is the integer generated by __LINE__;
 * @param error is the SQLite error number.
 */
extern void placer_error_f(const char * file, int line, int error);

/**
 * @def placer_error
 * Calls placer_error_f with __FILE__, __LINE__, and @a _ERROR_.
 */
#define placer_error(_ERROR_) placer_error_f(__FILE__, __LINE__, _ERROR_)
