 ...
 *
 * The Structure Definition feature generates a structure definition
 * from a schema.
 *
 ...
 * This macro generates the front matter for a C structure that describes
 * the memory layout of the schema.
 ...
 * This macro generates the end matter for a C structure that describes
 * the memory layout of the schema.
