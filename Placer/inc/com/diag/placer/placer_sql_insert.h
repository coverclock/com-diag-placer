 ...
 *
 * The SQL Insert feature generates an SQL INSERT command from a schema.
 *
 ...
 * This macro generates the front matter for an SQL INSERT for the schema.
...
#define PLACER_SCHEMA(_STRUCTURE_) \
    static const char PLACER_SQL_struct_##_STRUCTURE_##_INSERT[] = \
        "INSERT INTO " #_STRUCTURE_ " VALUES ("
 ...
 * This macro generates the end matter for an SQL INSERT for the schema.
