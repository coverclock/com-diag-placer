 ...
 *
 * The Steps Prototype feature generates a prototype for a step callback
 ...
 * This macro generates the front matter for prototype for a placer_steps()
 * callback function that loads the data from a single selected row in a table
...
/**
 * @def PLACER_SCHEMA(_STRUCTURE_)
 * This macro generates the end matter for prototype for a placer_steps()
 * callback function that loads the data from a single selected row in a table
 * into a structure for the schema.
 * @a _STRUCTURE_ is the schema name.
 */
